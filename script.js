...
class Factory {
  constructor() {
    ...
    this.massBuild = function(quantity, color, trim, model){
      return "Building " + quantity + " " + color + " " + trim + " " + model + "/'s";
    };
    this.customerBuild = function(color, trim, model, options){
      return "Building " + color + " " + trim + " " + model + " with the following options: " + options;
    }
  }
}
...
class Car extends Factory {
  constructor(model, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, warranty, doors, ) {
    super({warranty});
    this.model = model;
    this.doors = doors;
    this.color = color;
...
let buildThis = new Factory();

console.log(buildThis.massBuild(35000, "Red", "Touring", "Mazda3"));
...
console.log(buildThis.customerBuild("yellow", "Touring", "Mazda3", ["weather package", " satellite radio", " rear spoiler"]));
...
console.log(miataRf.massBuild(15000, "Red", "Grand Touring", "Miata-RF"))
...
console.log(miataRf.customerBuild("black", "Grand Touring", "Miata-RF", ["hid headlights", " sports suspension", " leather steering wheel", " heated seats", " adaptive cruise control"]));
...
let trailBlazer = new Truck("Trail Blazer", "blue", 8, true, "standard", true, {trim: "Sport"});
...
console.log(trailBlazer.massBuild(35000, "blue", "Sport", "Trail Blazer"))
...
console.log(trailBlazer.customerBuild("red", "Sport", "Trail Blazer", ["seat warmers", " tinted windows", " fog lamps"]))
